        ...
        {!isContentVisible && (
                        ...
                        {isContentVisible && (
                            <div className={`${contentClasses} flex relative w-full h-full -mt-0 rounded-md bg-[#212134] bg-opacity-30 justify-center items-center border border-teal-500`} onClick={toggleContent}>
                                <p className="m-2 p-2 text-teal-500 font-sans font-extrabold text-4xl absolute top-1 left-15">
                                    {check ? "Total Vendors" : "Total Files"}
                                </p>
                                <p className="m-2 p-2 text-teal-500 font-sans font-extrabold text-8xl absolute bottom-1 right-15">
                                    {check ? `${vendors}` : `${total}`}
                                </p>
                            </div>
                        )}
